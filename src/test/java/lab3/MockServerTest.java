...
public class MockServerTest {
    ...
    private static final String OWNER_NAME_UNSUCCESS = "/ownerName/unsuccess-GET";
    private static final String OWNER_NAME_SUCCESS = "/ownerName/success-GET";
    private static final String CREATE_SOMETHING_WITH_PERMISSION = "/createSomething?permission=yes-POST";
    private static final String CREATE_SOMETHING_NO_PERMISSION = "/createSomething-POST";
    private static final String UPDATE_ME = "/updateMe-PUT";
    private static final String DELETE_WORLD = "/deleteWorld-DELETE";
    ...
    public void verifyUpdateMe() {
        given().put(UPDATE_ME)
                .then().statusCode(HttpStatus.SC_OK)
                .and().body("name", equalTo(""))
                .and().body("surname", equalTo(""));
    }
